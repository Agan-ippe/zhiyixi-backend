...
import com.zhiyixi.model.enums.UserRoleEnum;
...
import static com.zhiyixi.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO>
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "zhimo";
     ...
     */
    @Override
    public UserDO getLoginUserPermitNull(HttpServletRequest request) {
        // 先判断是否已登录
        Object userObj = request.getSession().getAttribute(USER_LOGIN_STATE);
        UserDO currentUser = (UserDO) userObj;
        if (currentUser == null || currentUser.getId() == null) {
    ...
    @Override
    public List<UserVO> getUserVO(List<UserDO> userList) {
    ...
    @Override
    public QueryWrapper<UserDO> getQueryWrapper(UserQueryRequest userQueryRequest) {
